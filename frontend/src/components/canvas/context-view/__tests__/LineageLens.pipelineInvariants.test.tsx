...
describe('the pipeline recovers from a hostile condensation output (T26 R2, invariants c/d)', () => {
  ...
  it('(c) a dangling edge from condensation never reaches the board — the focal still renders, dev-asserts', () => {
    ...
    injectedEdge = { id: 'ghost', source: 'F', target: 'NEVER_DRAWN', count: 1, edgeTypeNorm: '', dimmed: false, cycleBack: false, cycleAnchor: false, labelVisible: false, labelT: 0.5, grainCoarse: false, sameAncestorFrame: null, inFrameLane: null, seamSlotted: false }
    renderWalk()
