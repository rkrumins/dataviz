...
import { Sparkles, ArrowLeft, Sun, Moon, BookOpen, Search } from 'lucide-react'
    ...
    <ScrollContainerContext.Provider value={scrollEl}>
      <div className="absolute inset-0 flex flex-col bg-canvas">
        ...
        <header className="shrink-0 h-14 flex items-center justify-between px-4 border-b border-glass-border glass-panel-subtle">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="flex items-center gap-2 pl-2.5 pr-2 py-1.5 rounded-lg text-xs font-medium text-ink-muted hover:text-ink bg-black/[0.03] dark:bg-white/[0.04] border border-glass-border hover:border-indigo-500/30 transition-colors"
        ...
        <div className="flex-1 flex overflow-hidden">
          <GuideSidebar onOpenSearch={() => setSearchOpen(true)} />
