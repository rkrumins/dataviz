        ...
        <>
            ...
            <div className="fixed inset-0 z-[61] flex items-center justify-center pointer-events-none">
                ...
                >
                    ...
                    <div className="flex items-center justify-between px-8 py-5 border-b border-glass-border bg-gradient-to-r from-black/[0.02] to-transparent dark:from-white/[0.02] shrink-0">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-xl font-bold text-ink">Asset Onboarding</h2>
                    ...
                    {wizardPhase === 'steps' && (
                        <div className="px-8 py-4 bg-black/[0.02] dark:bg-white/[0.02] border-b border-glass-border shrink-0">
                                    ...
                                    return (
                                        <div key={step.id} className="flex items-center">
                                                    ...
                                                    {isComplete
                                                        ...
                                                        : (
                                                            <span className={cn(
                                                                ...
                                                                isCurrent ? "border-transparent bg-white/20" : "border-glass-border",
                                                            )}>
                                                                {i + 1}
                                                            </span>
                                                        )}
                                            ...
                                            {i < STEPS.length - 1 && (
                                                <div className={cn(
                                                    "w-8 h-px mx-2",
                                                    isComplete ? "bg-emerald-400" : "bg-glass-border",
                                                )} />
                                            )}
                                        </div>
                                    )
                    ...
                    {wizardPhase === 'steps' && (
                        <div className="flex items-center justify-between px-8 py-5 border-t border-glass-border bg-black/[0.02] dark:bg-white/[0.02] shrink-0">
                            <button
                                onClick={goBack}
