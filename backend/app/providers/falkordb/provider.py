...
class FalkorDBProvider(ConnectionMixin, SchemaMixin, OntologyMixin, CacheMixin, AncestorMixin, ReadMixin, BrowseMixin, SimpleLineageMixin, AggregationMixin, GraphDataProvider):
    """
