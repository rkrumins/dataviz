 ...
 * NOT hand-written — so drift between what the frontend assumes offline and
 * what the server actually sends is a failing test
 * (`__tests__/providerTypes.catalog.test.ts`), not a support ticket.
 */
